...
const MaestroPerfil = () => {
	...
	const fetchUserInfo = () => {
		const userInfoPromise = api.get('teachers/me-info');
					...
					<div className="bg-white shadow-lg rounded-2xl p-6 w-full lg:w-2/3">
						...
						<form className="space-y-4">
							<div>
								...
								<input
									type="text"
									value={ userInfo.acronym + " " + userInfo.name + " " + userInfo.lastname || ''}
									className={`
										w-full p-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-yellow-400
										${!userInfo.name
